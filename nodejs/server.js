...
app.use('/gui', express.static(__dirname + '/frontend'));


// Configures the app's base path and api version.
sw.configureSwaggerPaths("", "/api-docs", "")
sw.configure("http://10.12.114.183:" + config.port, "1.0.0");



// Start the server
app.listen(config.port);
console.log("Room presence API started on port " + config.port);
